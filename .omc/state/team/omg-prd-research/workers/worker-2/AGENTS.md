...
```bash
mkdir -p $(dirname .omc/state/team/omg-prd-research/workers/worker-2/.ready) && touch .omc/state/team/omg-prd-research/workers/worker-2/.ready
```
...
- **Worker**: worker-2
- **Agent Type**: codex
- **Environment**: OMC_TEAM_WORKER=omg-prd-research/worker-2
...
- **Inbox**: Read .omc/state/team/omg-prd-research/workers/worker-2/inbox.md for new instructions
- **Heartbeat**: Update .omc/state/team/omg-prd-research/workers/worker-2/heartbeat.json every few minutes:
  ```json
...
- Path: .omc/state/team/omg-prd-research/workers/worker-2/done.json
...
2. Write an ACK file: .omc/state/team/omg-prd-research/workers/worker-2/shutdown-ack.json
3. Exit
