...
```bash
mkdir -p $(dirname .omc/state/team/omg-prd-research/workers/worker-3/.ready) && touch .omc/state/team/omg-prd-research/workers/worker-3/.ready
```
...
- **Worker**: worker-3
- **Agent Type**: codex
- **Environment**: OMC_TEAM_WORKER=omg-prd-research/worker-3
...
- **Inbox**: Read .omc/state/team/omg-prd-research/workers/worker-3/inbox.md for new instructions
- **Heartbeat**: Update .omc/state/team/omg-prd-research/workers/worker-3/heartbeat.json every few minutes:
  ```json
...
- Path: .omc/state/team/omg-prd-research/workers/worker-3/done.json
...
2. Write an ACK file: .omc/state/team/omg-prd-research/workers/worker-3/shutdown-ack.json
3. Exit
